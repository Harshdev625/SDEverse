  ...
  if (dsCategoriesError) {
    return (
      ...
      >
        ...
        >
          We couldn't fetch the data structure categories. Please check your
  ...
  return (
    ...
    >
      <div
        ...
        } rounded-3xl shadow-3xl overflow-hidden border ${
      ...
      >
        ...
        <div
          className={`relative z-10 p-6 md:p-8 lg:p-8 border-b ${
            themeMode === "dark" ? "border-gray-700" : "border-gray-300"
          }`}
        >
          <Motion.button
            ...
            } transition-colors duration-200 transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 ${
              themeMode === "dark"
          ...
          <div className="text-left">
            <h1
              className={`text-4xl md:text-5xl font-extrabold mb-2 leading-tight tracking-tight ${
        ...
        >
          {["edit", "preview"].map((tab) => (
            <button
              ...
              onClick={() => setMode(tab)}
              className={clsx(
                "flex-1 py-4 px-6 text-center text-xl font-bold transition-all duration-200 relative group",
                mode === tab
                  ? `text-purple-400 ${
                      themeMode === "dark" ? "bg-gray-850" : "bg-white"
                    }`
                  : `${
                      themeMode === "dark"
                        ? "text-gray-500 hover:text-purple-300 bg-gray-800"
                        : "text-gray-600 hover:text-purple-500 bg-gray-100"
                    }`
              )}
        ...
        <div
          className={`relative z-10 p-6 md:p-8 lg:p-8 ${
            themeMode === "dark" ? "bg-gray-850" : "bg-white"
          } border-t ${
            themeMode === "dark" ? "border-gray-700" : "border-gray-300"
          } rounded-b-3xl`}
        ...
        >
          <div className="flex flex-col-reverse sm:flex-row justify-end gap-5">
            <Motion.button
              ...
              } font-semibold text-lg hover:shadow-lg transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 ${
                themeMode === "dark"
                  ? "focus:ring-offset-gray-900"
                  : "focus:ring-offset-white"
