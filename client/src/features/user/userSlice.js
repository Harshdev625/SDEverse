  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(changeUserRole.fulfilled, (state, action) => {
        const index = state.users.findIndex((u) => u._id === action.meta.arg.id);
        if (index !== -1) {
      ...
      .addCase(patchMyProfile.fulfilled, (state, action) => {
        ...
        state.myProfile = action.payload;  // Full user object
      })
      ...
      .addCase(refreshCompetitiveStats.fulfilled, (state, action) => {
        ...
        if (state.myProfile) {
          ...
          state.myProfile.extraCompetitiveStats = action.payload.extraStats;
        }
      })
      ...
      .addCase(refreshSingleSocialStat.fulfilled, (state, action) => {
        ...
        if (state.myProfile) {
          state.myProfile.socialStats = action.payload.socialStats;
          state.myProfile.extraSocialStats = { ...(state.myProfile.extraSocialStats || {}), ...action.payload.extraSocialStats };
        }
      })
      ...
      .addCase(refreshSingleCompetitiveStat.fulfilled, (state, action) => {
        ...
        if (state.myProfile) {
          state.myProfile.competitiveStats = action.payload.competitiveStats;
          state.myProfile.extraCompetitiveStats = { ...(state.myProfile.extraCompetitiveStats || {}), ...action.payload.extraStats };
        }
      })
